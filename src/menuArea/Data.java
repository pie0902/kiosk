...
public class Data {
    ...
    //메인 메뉴 출력 변수
    //메뉴판 리스트
    private HashMap<DataKey,StringBuffer> menuData = new HashMap<DataKey,StringBuffer>();
    //햄버거 메뉴판 리스트
    private HashMap<Integer,Product> bugerList = new HashMap<Integer,Product>();
    //아이스크림 메뉴판 리스트
    private  HashMap<Integer,Product> forzenList = new HashMap<Integer,Product>();
    //음료수 메뉴판 리스트
    private  HashMap<Integer,Product> drinkkList = new HashMap<Integer,Product>();
    //맥주 메뉴판 리스트
    private   HashMap<Integer,Product> beerList = new HashMap<Integer,Product>();
    //생성자
    public Data() {
        board();
        productListData();
    ...
    private void board(){
        ...
        StringBuffer buger = new StringBuffer(" \"SHAKESHACK BURGER 에 오신걸 환영합니다.\"\n" +
        ...
        StringBuffer forzen = new StringBuffer(" \"SHAKESHACK BURGER 에 오신걸 환영합니다.\"\n" +
                "아래 상품메뉴판을 보시고 상품을 골라 입력해주세요.\n" +
                "\n" +
                "[ Forzen Custard MENU ]\n" +
        ...
        menuData.put(DataKey.FORZEN, forzen);
        StringBuffer drink = new StringBuffer(" \"SHAKESHACK BURGER 에 오신걸 환영합니다.\"\n" +
                "아래 상품메뉴판을 보시고 상품을 골라 입력해주세요.\n" +
                "\n" +
                "[ Drink MENU ]\n" +
                "1. Cola   | W 1.5 | 콜라\n" +
        ...
        StringBuffer beer = new StringBuffer(" \"SHAKESHACK BURGER 에 오신걸 환영합니다.\"\n" +
                "아래 상품메뉴판을 보시고 상품을 골라 입력해주세요.\n" +
                "\n" +
                "[ Beer MENU ]\n" +
                "1. Cass   | W 2.9 | 카스\n" +
        ...
        StringBuffer add = new StringBuffer("위 메뉴를 장바구니에 추가하시겠습니까?\n" +
                "1. 확인        2. 취소");
        menuData.put(DataKey.ADD, add);
        StringBuffer cancle = new StringBuffer("진행하던 주문을 취소하시겠습니까?\n" +
                "1. 확인        2. 취소");
    ...
    private void productListData() {
        ...
        addProduct(forzenList, 1, "Chocolate IceCream", "초코맛 아이스크림", 1.9);
        addProduct(forzenList, 2, "StrawberryIceCream ", "딸기맛 아이스크림", 1.9);
        addProduct(forzenList, 3, "Oreo IceCream", "오레오 아이스크림", 2.9);
    ...
    public void getProductData(HashMap<Integer,Product> list,int num){
